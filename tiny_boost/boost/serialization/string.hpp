...
BOOST_CLASS_IMPLEMENTATION(std::string, abt_boost::serialization::primitive_type)
#ifndef BOOST_NO_STD_WSTRING
BOOST_CLASS_IMPLEMENTATION(std::wstring, abt_boost::serialization::primitive_type)
#endif
...
inline void save(
    ...
    abt_boost::serialization::stl::save_collection<
...
inline void load(
    ...
    abt_boost::serialization::stl::load_collection<
        ...
        abt_boost::serialization::stl::archive_input_seq<
            ...
            std::basic_string<U, Allocator> 
        >,
        abt_boost::serialization::stl::reserve_imp<
            std::basic_string<U, Allocator> 
        >
    >(ar, t);
}
