...
struct static_warning_test{
    typename abt_boost::mpl::eval_if_c<
        B,
        abt_boost::mpl::true_,
        typename abt_boost::mpl::identity<
            abt_boost::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef abt_boost::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( abt_boost::serialization::static_warning_test< B, L > ) \
