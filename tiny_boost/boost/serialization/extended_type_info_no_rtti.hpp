...
public:
    virtual bool
    is_less_than(const abt_boost::serialization::extended_type_info &rhs) const ;
    virtual bool
    is_equal(const abt_boost::serialization::extended_type_info &rhs) const ;
};
...
public:
    ...
    get_derived_extended_type_info(const T & t) const {
        ...
        BOOST_STATIC_WARNING(abt_boost::is_polymorphic< T >::value);
        const char * derived_key = t.get_key();
        BOOST_ASSERT(NULL != derived_key);
        return abt_boost::serialization::extended_type_info::find(derived_key);
    }
    ...
    virtual void * construct(unsigned int count, ...) const{
        ...
        switch(count){
        case 0:
            return factory<BOOST_DEDUCED_TYPENAME abt_boost::remove_const< T >::type, 0>(ap);
        case 1:
            return factory<BOOST_DEDUCED_TYPENAME abt_boost::remove_const< T >::type, 1>(ap);
        case 2:
            return factory<BOOST_DEDUCED_TYPENAME abt_boost::remove_const< T >::type, 2>(ap);
        case 3:
            return factory<BOOST_DEDUCED_TYPENAME abt_boost::remove_const< T >::type, 3>(ap);
        case 4:
            return factory<BOOST_DEDUCED_TYPENAME abt_boost::remove_const< T >::type, 4>(ap);
        default:
    ...
    virtual void destroy(void const * const p) const{
        abt_boost::serialization::access::destroy(
...
// before any of the other headers.
    ...
    struct extended_type_info_impl {
        typedef BOOST_DEDUCED_TYPENAME 
            abt_boost::serialization::extended_type_info_no_rtti< T > type;
    };
    } // namespace serialization
    } // namespace abt_boost
#endif
