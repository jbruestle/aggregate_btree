...
public:
  ...
  typedef typename
    abt_boost::reverse_iterator<iterator>                 reverse_iterator;
  typedef typename
    abt_boost::reverse_iterator<const_iterator>           const_reverse_iterator;
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  {
    lm.load(
      ::abt_boost::bind(&sequenced_index::rearranger,this,_1,_2),
      ar,version);
  ...
  /* This forwarding function eases things for the abt_boost::mem_fn construct
...
template<typename SuperMeta,typename TagList>
inline abt_boost::mpl::true_* boost_foreach_is_noncopyable(
  abt_boost::multi_index::detail::sequenced_index<SuperMeta,TagList>*&,
  abt_boost::foreach::tag)
{
  return 0;
}
