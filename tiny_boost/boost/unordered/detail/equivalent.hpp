...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace unordered { namespace detail {
    ...
    {
        typedef abt_boost::unordered::detail::grouped_node<A, T> node;
    ...
    struct pick_grouped_node2<A, T,
        abt_boost::unordered::detail::grouped_ptr_node<T>*,
        abt_boost::unordered::detail::ptr_bucket*>
    {
        typedef abt_boost::unordered::detail::grouped_ptr_node<T> node;
    ...
    struct pick_grouped_node
    {
        typedef abt_boost::unordered::detail::allocator_traits<
            typename abt_boost::unordered::detail::rebind_wrap<A,
                abt_boost::unordered::detail::grouped_ptr_node<T> >::type
    ...
    struct multiset
    {
        typedef abt_boost::unordered::detail::multiset<A, T, H, P> types;
        ...
        typedef abt_boost::unordered::detail::pick_grouped_node<allocator, value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef abt_boost::unordered::detail::grouped_table_impl<types> table;
    ...
    struct multimap
    {
        typedef abt_boost::unordered::detail::multimap<A, K, M, H, P> types;
    ...
    struct grouped_table_impl : abt_boost::unordered::detail::table<Types>
    {
        ...
        iterator emplace(abt_boost::unordered::detail::emplace_args1<
        ...
        template <class I>
        typename abt_boost::unordered::detail::enable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            if(i == j) return;

            std::size_t distance = abt_boost::unordered::detail::distance(i, j);
            if(distance == 1) {
                node_constructor a(this->node_alloc());
                a.construct_node();
        ...
        template <class I>
        typename abt_boost::unordered::detail::disable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            node_constructor a(this->node_alloc());
            for (; i != j; ++i) {
