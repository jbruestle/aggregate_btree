...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace unordered { namespace detail {
    ...
    struct node :
        abt_boost::unordered::detail::value_base<T>
    {
        typedef typename ::abt_boost::unordered::detail::rebind_wrap<
    ...
    struct ptr_node :
        abt_boost::unordered::detail::value_base<T>,
        abt_boost::unordered::detail::ptr_bucket
    {
        typedef abt_boost::unordered::detail::ptr_bucket bucket_base;
    ...
    struct pick_node2
    {
        typedef abt_boost::unordered::detail::node<A, T> node;

        typedef typename abt_boost::unordered::detail::allocator_traits<
            typename abt_boost::unordered::detail::rebind_wrap<A, node>::type
        >::pointer node_pointer;

        typedef abt_boost::unordered::detail::bucket<node_pointer> bucket;
        typedef node_pointer link_pointer;
    };

    template <typename A, typename T>
    struct pick_node2<A, T,
        abt_boost::unordered::detail::ptr_node<T>*,
        abt_boost::unordered::detail::ptr_bucket*>
    {
        typedef abt_boost::unordered::detail::ptr_node<T> node;
        typedef abt_boost::unordered::detail::ptr_bucket bucket;
    ...
    struct pick_node
    {
        typedef abt_boost::unordered::detail::allocator_traits<
            typename abt_boost::unordered::detail::rebind_wrap<A,
                abt_boost::unordered::detail::ptr_node<T> >::type
        > tentative_node_traits;

        typedef abt_boost::unordered::detail::allocator_traits<
            typename abt_boost::unordered::detail::rebind_wrap<A,
                abt_boost::unordered::detail::ptr_bucket >::type
    ...
    struct set
    {
        typedef abt_boost::unordered::detail::set<A, T, H, P> types;
        ...
        typedef abt_boost::unordered::detail::allocator_traits<allocator> traits;
        typedef abt_boost::unordered::detail::pick_node<allocator, value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef abt_boost::unordered::detail::table_impl<types> table;
        typedef abt_boost::unordered::detail::set_extractor<value_type> extractor;
    };

    template <typename A, typename K, typename M, typename H, typename P>
    struct map
    {
        typedef abt_boost::unordered::detail::map<A, K, M, H, P> types;
        ...
        typedef abt_boost::unordered::detail::table_impl<types> table;
        typedef abt_boost::unordered::detail::map_extractor<key_type, value_type>
            extractor;
    };

    template <typename Types>
    struct table_impl : abt_boost::unordered::detail::table<Types>
    {
        typedef abt_boost::unordered::detail::table<Types> table;
        ...
        table_impl(table_impl& x,
                abt_boost::unordered::detail::move_tag m)
          : table(x, m)
        {}
        ...
        value_type& operator[](key_type const& k)
        {
            ...
            a.construct_value(abt_boost::unordered::piecewise_construct,
                abt_boost::make_tuple(k), abt_boost::make_tuple());
#else
            a.construct_value(
                abt_boost::unordered::detail::create_emplace_args(
                    abt_boost::unordered::piecewise_construct,
                    abt_boost::make_tuple(k),
                    abt_boost::make_tuple()));
#endif
        ...
        emplace_return emplace(abt_boost::unordered::detail::emplace_args1<
                abt_boost::unordered::detail::please_ignore_this_overload> const&)
        {
            BOOST_ASSERT(false);
        ...
        emplace_return emplace(
                abt_boost::unordered::detail::emplace_args1<A0> const& args)
        {
            ...
            InputIt i, InputIt j)
        {
            ...
            this->reserve_for_insert(this->size_ +
                abt_boost::unordered::detail::insert_size(i, j));
        ...
        static void move_buckets_to(buckets& src, buckets& dst)
        {
            ...
            while(n) {
                a.construct_node();
                a.construct_value2(abt_boost::move(n->value()));
