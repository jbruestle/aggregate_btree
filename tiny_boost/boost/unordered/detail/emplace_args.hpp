...
#define BOOST_UNORDERED_EMPLACE_FORWARD abt_boost::forward<Args>(args)...
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a) \
    abt_boost::forward<BOOST_PP_CAT(A,i)>(BOOST_PP_CAT(a,i))
...
#define BOOST_UNORDERED_EARGS_INIT(z, n, _)                                 \
    BOOST_PP_CAT(a, n)(                                                     \
        abt_boost::forward<BOOST_PP_CAT(A,n)>(BOOST_PP_CAT(a, n)))

#else

#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                               \
    typedef typename abt_boost::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type  \
        BOOST_PP_CAT(Arg, n);                                               \
    BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
#   define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
    ...
    template <typename T>
    struct rv_ref :
        abt_boost::detail::if_true<
            abt_boost::is_class<T>::value
        >::BOOST_NESTED_TEMPLATE then <
            abt_boost::unordered::detail::rv_ref_impl<T>,
            please_ignore_this_overload
        >::type
    {};

#   define BOOST_UNORDERED_RV_REF(T) \
        typename abt_boost::unordered::detail::rv_ref<T>::type
#endif
...
#undef BOOST_UNORDERED_GET_TUPLE_ARG
    ...
    void construct_from_tuple_impl(
            abt_boost::unordered::detail::length<0>, T* ptr,
            abt_boost::tuple<>)
    {
        new ((void*) ptr) T();
    }
...
#define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE_IMPL(z, n, _)                  \
    template<typename T, BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>          \
    void construct_from_tuple_impl(                                         \
            abt_boost::unordered::detail::length<n>, T* ptr,                    \
            namespace_::tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)    \
    {                                                                       \
        new ((void*) ptr) T(                                                \
            BOOST_PP_ENUM_##z(n, BOOST_UNORDERED_GET_TUPLE_ARG, namespace_) \
...
#define BOOST_UNORDERED_GET_TUPLE_ARG(z, n, _)                              \
    ...
    void construct_from_tuple(T* ptr, Tuple const& x)
    {
        construct_from_tuple_impl(
            abt_boost::unordered::detail::length<
                abt_boost::tuples::length<Tuple>::value>(),
            ptr, x);
    }
...
#undef BOOST_UNORDERED_GET_TUPLE_ARG
    ...
    struct emulation1 {
        ...
        enum { value =
            sizeof(test(choose(), abt_boost::unordered::detail::make<A0>())) ==
                sizeof(choice2::type) };
    };
#endif
    ...
    struct check3_base {
        static choice1::type test(choice1,
            abt_boost::unordered::piecewise_construct_t);
    ...
    {
        new((void*) address) T(abt_boost::forward<Args>(args)...);
    }
    ...
    {
        abt_boost::unordered::detail::construct_from_tuple(
            abt_boost::addressof(address->first), a1);
        abt_boost::unordered::detail::construct_from_tuple(
            abt_boost::addressof(address->second), a2);
    }
    ...
    {
        new((void*) abt_boost::addressof(address->first)) A(abt_boost::forward<A0>(a0));
        new((void*) abt_boost::addressof(address->second)) B();
   }
        ...
        construct_impl(std::pair<A, B>* address, A0&& a0, A1&& a1, A2&& a2)
    {
        new((void*) abt_boost::addressof(address->first)) A(abt_boost::forward<A0>(a0));
        new((void*) abt_boost::addressof(address->second)) B(
            abt_boost::forward<A1>(a1),
            abt_boost::forward<A2>(a2));
    }
            ...
            A0&& a0, A1&& a1, A2&& a2, A3&& a3, Args&&... args)
    {
        ...
        new((void*) abt_boost::addressof(address->second)) B(
            abt_boost::forward<A1>(a1),
            abt_boost::forward<A2>(a2),
            abt_boost::forward<A3>(a3),
            abt_boost::forward<Args>(args)...);
    }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                    \
    ...
    inline void construct_impl(T* address,                                  \
        abt_boost::unordered::detail::BOOST_PP_CAT(emplace_args,num_params) <   \
    ...
    {
        new((void*) address) T(abt_boost::forward<A0>(args.a0));
    }
    ...
    {
        new((void*) address) T(
            abt_boost::forward<A0>(args.a0),
            abt_boost::forward<A1>(args.a1)
        );
    }
...
#undef BOOST_UNORDERED_CONSTRUCT_IMPL
    ...
    inline typename enable_if<piecewise3<A, B, A0>, void>::type
        construct_impl(std::pair<A, B>* address,
            abt_boost::unordered::detail::emplace_args3<A0, A1, A2> const& args)
    {
        abt_boost::unordered::detail::construct_from_tuple(
            abt_boost::addressof(address->first), args.a1);
        abt_boost::unordered::detail::construct_from_tuple(
            abt_boost::addressof(address->second), args.a2);
    }
    ...
    {
        new((void*) abt_boost::addressof(address->first)) A(
            abt_boost::forward<A0>(args.a0));
        new((void*) abt_boost::addressof(address->second)) B();
    }
