...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace unordered { namespace detail {
    ...
    private:
        ...
        typedef abt_boost::unordered::detail::allocator_traits<NodeAlloc>
    ...
    public:
        ...
        void construct_value(BOOST_UNORDERED_EMPLACE_ARGS)
        {
            ...
            abt_boost::unordered::detail::construct_impl(
        ...
        {
            BOOST_ASSERT(node_ && node_constructed_ && !value_constructed_);
            abt_boost::unordered::detail::construct_impl2(
                node_->value_ptr(), abt_boost::forward<A0>(a0));
            value_constructed_ = true;
        }
    ...
    node_constructor<Alloc>::~node_constructor()
    {
        if (node_) {
            if (value_constructed_) {
                abt_boost::unordered::detail::destroy(node_->value_ptr());
            }

            if (node_constructed_) {
                node_allocator_traits::destroy(alloc_,
                    abt_boost::addressof(*node_));
            }
    ...
    void node_constructor<Alloc>::construct_node()
    {
        if(!node_) {
            ...
            node_allocator_traits::construct(alloc_,
                abt_boost::addressof(*node_), node());
    ...
    public:
        typedef abt_boost::unordered::detail::allocator_traits<A> traits;
        typedef typename traits::value_type value_type;

        typedef Node node;
        typedef Bucket bucket;
        typedef typename abt_boost::unordered::detail::rebind_wrap<A, node>::type
            node_allocator;
        typedef typename abt_boost::unordered::detail::rebind_wrap<A, bucket>::type
            bucket_allocator;
        typedef abt_boost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef abt_boost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket::previous_pointer
            previous_pointer;
        typedef abt_boost::unordered::detail::node_constructor<node_allocator>
            node_constructor;
        ...
        std::size_t size_;
        abt_boost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        std::size_t max_bucket_count() const
        {
            ...
            return abt_boost::unordered::detail::prev_prime(
        ...
        buckets(buckets& b, abt_boost::unordered::detail::move_tag m) :
            buckets_(),
        ...
        buckets(abt_boost::unordered::detail::table<Types>& x,
        ...
        void create_buckets()
        {
            abt_boost::unordered::detail::array_constructor<bucket_allocator>
        ...
        void swap(buckets& other, false_type = false_type())
        {
            ...
            abt_boost::swap(buckets_, other.buckets_);
            abt_boost::swap(bucket_count_, other.bucket_count_);
            abt_boost::swap(size_, other.size_);
        }
        ...
        {
            abt_boost::unordered::detail::destroy(n->value_ptr());
            node_allocator_traits::destroy(node_alloc(), abt_boost::addressof(*n));
    ...
    class functions
    {
        friend class abt_boost::unordered::detail::set_hash_functions<H, P>;
        functions& operator=(functions const&);

        typedef compressed<H, P> function_pair;

        typedef typename abt_boost::aligned_storage<
            sizeof(function_pair),
            abt_boost::alignment_of<function_pair>::value>::type aligned_function;
        ...
        {
            abt_boost::unordered::detail::destroy((function_pair*)(&funcs_[which]));
        }
