...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace unordered { namespace iterator_detail {
            ...
            NodePointer, Value&>
    {
        ...
        template <typename ConstNodePointer, typename NodePointer2,
                typename Value2>
        friend struct abt_boost::unordered::iterator_detail::cl_iterator;
    private:
#endif
    ...
    {
        friend struct abt_boost::unordered::iterator_detail::l_iterator
            <NodePointer, Value>;
    private:
    ...
    public:
        ...
        cl_iterator(abt_boost::unordered::iterator_detail::l_iterator<
            ...
            NodePointer, Value&>
    {
        ...
        template <typename ConstNodePointer, typename NodePointer2,
                typename Value2>
        friend struct abt_boost::unordered::iterator_detail::c_iterator;
    private:
#endif
        typedef NodePointer node_pointer;
        node_pointer node_;
    ...
    struct c_iterator
        : public abt_boost::iterator<
            ...
            ConstNodePointer, Value const&>
    {
        friend struct abt_boost::unordered::iterator_detail::iterator<
                NodePointer, Value>;

#if !defined(BOOST_NO_MEMBER_TEMPLATE_FRIENDS)
        template <typename K, typename T, typename H, typename P, typename A>
        friend class abt_boost::unordered::unordered_map;
        template <typename K, typename T, typename H, typename P, typename A>
        friend class abt_boost::unordered::unordered_multimap;
        template <typename T, typename H, typename P, typename A>
        friend class abt_boost::unordered::unordered_set;
        template <typename T, typename H, typename P, typename A>
        friend class abt_boost::unordered::unordered_multiset;
    ...
    public:
        ...
        c_iterator(abt_boost::unordered::iterator_detail::iterator<
...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename abt_boost::aligned_storage<
            sizeof(value_type),
            abt_boost::alignment_of<value_type>::value>::type data_;
    ...
    struct table :
        abt_boost::unordered::detail::buckets<
            typename Types::allocator,
            typename Types::bucket,
            typename Types::node>,
        abt_boost::unordered::detail::functions<
    ...
    public:
        ...
        typedef abt_boost::unordered::detail::functions<
            typename Types::hasher,
            typename Types::key_equal> functions;

        typedef abt_boost::unordered::detail::buckets<
            typename Types::allocator,
            typename Types::bucket,
        ...
        typedef abt_boost::unordered::iterator_detail::
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return abt_boost::unordered::detail::double_to_size(ceil(
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
            ...
            return abt_boost::unordered::detail::next_prime(
                abt_boost::unordered::detail::double_to_size(floor(
        ...
        table(std::size_t num_buckets,
            ...
            buckets(a, abt_boost::unordered::detail::next_prime(num_buckets)),
            functions(hf, eq),
            mlf_(1.0f),
            max_load_(0)
        {}
        ...
        table(table& x, abt_boost::unordered::detail::move_tag m) :
            buckets(x, m),
            functions(x),
            mlf_(x.mlf_),
        ...
        {
            assign(x,
                abt_boost::unordered::detail::integral_constant<bool,
        ...
        void move_assign(table& x, false_type)
        {
            if(this->node_alloc() == x.node_alloc()) {
                ...
                abt_boost::unordered::detail::set_hash_functions<hasher, key_equal>
