...
namespace unordered
{
    ...
    private:
        ...
        typedef abt_boost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
        ...
        explicit unordered_map(
                size_type = abt_boost::unordered::detail::default_bucket_count,
                const hasher& = hasher(),
        ...
        unordered_map(BOOST_RV_REF(unordered_map) other)
            : table_(other.table_, abt_boost::unordered::detail::move_tag())
        {
        }
        ...
        {
            return table_.emplace(abt_boost::forward<Args>(args)...);
        }

        template <class... Args>
        iterator emplace_hint(const_iterator, Args&&... args)
        {
            return table_.emplace(abt_boost::forward<Args>(args)...).first;
        }
#else
        ...
        std::pair<iterator, bool> emplace(
                abt_boost::unordered::detail::empty_emplace
                    = abt_boost::unordered::detail::empty_emplace(),
                value_type v = value_type())
        {
            return this->emplace(abt_boost::move(v));
        }
        ...
        {
            return this->emplace_hint(hint, abt_boost::move(v));
        }
...
#undef BOOST_UNORDERED_EMPLACE
        ...
        {
            return this->emplace(abt_boost::move(x));
        }
        ...
        {
            return this->emplace_hint(hint, abt_boost::move(x));
        }
    ...
    private:
        ...
        typedef abt_boost::unordered::detail::multimap<A, K, T, H, P> types;
        typedef typename types::allocator value_allocator;
        typedef typename types::traits allocator_traits;
        typedef typename types::table table;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    unordered_map<K,T,H,P,A>::unordered_map(allocator_type const& a)
      : table_(abt_boost::unordered::detail::default_bucket_count,
            hasher(), key_equal(), a)
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(InputIt f, InputIt l)
      : table_(abt_boost::unordered::detail::initial_size(f, l),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const hasher &hf,
            const key_equal &eql)
      : table_(abt_boost::unordered::detail::initial_size(f, l, n),
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
            ...
            const key_equal &eql,
            const allocator_type &a)
      : table_(abt_boost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
        table_.insert_range(f, l);
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(other.table_, a, abt_boost::unordered::detail::move_tag())
    {
    }
    ...
    unordered_map<K,T,H,P,A>::unordered_map(
      ...
      : table_(
            abt_boost::unordered::detail::initial_size(
