...
//If boost dependencies are avoided include all machinery
   ...
   #define BOOST_MOVE_MPL_NS    ::abt_boost::mpl
   #define BOOST_MOVE_BOOST_NS  ::boost
#else
   #define BOOST_MOVE_MPL_NS    ::abt_boost::move_detail
   #define BOOST_MOVE_BOOST_NS  ::abt_boost::move_detail
...
//Small meta-typetraits to support move
   ...
   {
      return ::abt_boost::move_detail::addressof_impl<T>::f
         ( ::abt_boost::move_detail::addr_impl_ref<T>( v ), 0 );
   }
...
/// @endcond
   ...
   class rv
      : public BOOST_MOVE_MPL_NS::if_c
         < ::abt_boost::move_detail::is_class_or_union<T>::value
         , T
         , ::abt_boost::move_detail::empty
         >::type
   {
      rv();
      ~rv();
   ...
   struct has_move_emulation_enabled
      : BOOST_MOVE_BOOST_NS::is_convertible< T, ::abt_boost::rv<T>& >
   {};
   ...
   template<class T>
   struct has_move_emulation_enabled< ::abt_boost::rv<T> >
      : BOOST_MOVE_BOOST_NS::integral_constant<bool, false>
   {};
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::abt_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::abt_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_MOVE_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::abt_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_MOVE_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::abt_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   template <class T>
   inline typename BOOST_MOVE_BOOST_NS::enable_if< ::abt_boost::move_detail::is_rv<T>, T &>::type
   ...
   template <class T>
   inline typename BOOST_MOVE_BOOST_NS::disable_if< ::abt_boost::move_detail::is_rv<T>, const T &>::type
      forward(const typename BOOST_MOVE_MPL_NS::identity<T>::type &x)
   {
      return x;
   }
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      TYPE& operator=(TYPE &);\
      public:\
      operator ::abt_boost::rv<TYPE>&() \
      {  return *static_cast< ::abt_boost::rv<TYPE>* >(this);  }\
      operator const ::abt_boost::rv<TYPE>&() const \
      {  return *static_cast<const ::abt_boost::rv<TYPE>* >(this);  }\
      private:\
   //
   ...
   #define BOOST_COPYABLE_AND_MOVABLE(TYPE)\
      ...
      {  this->operator=(static_cast<const ::abt_boost::rv<TYPE> &>(const_cast<const TYPE &>(t))); return *this;}\
      public:\
      operator ::abt_boost::rv<TYPE>&() \
      {  return *static_cast< ::abt_boost::rv<TYPE>* >(this);  }\
      operator const ::abt_boost::rv<TYPE>&() const \
   ...
   {};
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //! <i>::abt_boost::rv<T> &</i> so that move emulation is activated.
         template <class T> 
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //!
         //! Otherwise:
         //! * If input_reference binds to const ::abt_boost::rv<T> & then it output_reference is
         //!   ::abt_boost::rev<T> &
         //!
...
class move_iterator
{
   ...
   typedef typename BOOST_MOVE_MPL_NS::if_
      < ::abt_boost::has_move_emulation_enabled<value_type>
      , ::abt_boost::rv<value_type>&
...
template <class I>
struct is_move_iterator< ::abt_boost::move_iterator<I> >
   ...
   : public std::iterator<std::output_iterator_tag, void, void, void, void>
{
   ...
   { container_m->push_back(abt_boost::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(abt_boost::move(x)); return *this; }
   ...
   : public std::iterator<std::output_iterator_tag, void, void, void, void>
{
   ...
   {
      pos_ = container_m->insert(pos_, ::abt_boost::move(x));
      ++pos_;
      return *this;
   }
...
//////////////////////////////////////////////////////////////////////////////
   ...
   //!   performs *(result + n) = ::abt_boost::move (*(first + n)).
   //!
   ...
   //!   performs *(result - n) = ::abt_boost::move(*(last - n)).
   //!
   //! <b>Requires</b>: result shall not be in the range [first,last).
   //!
...
//!         typename iterator_traits<ForwardIterator>::value_type(abt_boost::move(*first));
//!   \endcode
//!
//! <b>Returns</b>: result
template
   ...
   )
{
   ...
   while (f != l) {
      ::new(static_cast<void*>(&*r)) input_value_type(abt_boost::move(*f));
      ++f; ++r;
   }
   return r;
}
...
{
   return ::abt_boost::uninitialized_move(f, l, r);
}
/*
template
<typename I,   // I models InputIterator
...
{
   return ::abt_boost::move_detail::uninitialized_move_move_iterator(f, l, r);
}
...
inline F copy_or_move(I f, I l, F r,
                             typename BOOST_MOVE_BOOST_NS::enable_if< move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::abt_boost::move_detail::move_move_iterator(f, l, r);
}
...
// Code from Jeffrey Lee Hellrung, many thanks
   ...
   template< class T>
   struct forward_type< abt_boost::rv<T> >
   { typedef T type; };
...
template< class T > struct is_rvalue_reference : BOOST_MOVE_BOOST_NS::integral_constant<bool, false> { };
...
#else // #ifndef BOOST_NO_RVALUE_REFERENCES
   template< class T > struct is_rvalue_reference< abt_boost::rv<T>& >
      :  BOOST_MOVE_BOOST_NS::integral_constant<bool, true>
   {};

   template< class T > struct is_rvalue_reference< const abt_boost::rv<T>& >
      : BOOST_MOVE_BOOST_NS::integral_constant<bool, true>
   {};
#endif // #ifndef BOOST_NO_RVALUE_REFERENCES
   ...
   {
      template< class T
              , bool emulation = ::abt_boost::has_move_emulation_enabled<T>::value
              , bool rv        = ::abt_boost::move_detail::is_rv<T>::value  >
      ...
      struct add_rvalue_reference_impl< T, true, rv > { typedef ::abt_boost::rv<T>& type; };
   } // namespace detail_add_rvalue_reference
...
template <typename T>
typename abt_boost::move_detail::add_rvalue_reference<T>::type declval();
