...
struct default_result_converter
{
    ...
    struct apply
    {
        typedef typename mpl::if_<
          ...
          , abt_boost::python::to_python_value<
...
{
    typedef abt_boost::python::to_python_value<char const*const&> type;
};

template <>
struct default_result_converter::apply<PyObject*>
{
    typedef abt_boost::python::to_python_value<PyObject*const&> type;
};
