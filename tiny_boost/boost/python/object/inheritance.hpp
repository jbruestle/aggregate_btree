...
struct dynamic_id_generator
  : mpl::if_<
        abt_boost::is_polymorphic<T>
        , abt_boost::python::objects::polymorphic_id_generator<T>
        , abt_boost::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
inline void register_conversion(
    bool is_downcast = ::abt_boost::is_base_and_derived<Source,Target>::value
...
}}} // namespace abt_boost::python::object
