...
{
    typedef typename abt_boost::add_reference<
        T
...
struct back_reference_arg_from_python
    : abt_boost::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef abt_boost::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
          ...
          , if_2<
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , mpl::if_<
                            abt_boost::python::is_back_reference<T>
