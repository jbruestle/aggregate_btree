...
namespace detail
{
  ...
  )
  {
      return objects::make_iterator_function<Target>(
          abt_boost::protect(abt_boost::bind(get_start, _1))
        , abt_boost::protect(abt_boost::bind(get_finish, _1))
        , next_policies
      );
  }
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, abt_boost::type<Target>* = 0)
{
