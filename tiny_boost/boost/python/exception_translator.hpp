...
void register_exception_translator(Translate translate, abt_boost::type<ExceptionType>* = 0)
{
    detail::register_exception_handler(
        abt_boost::bind<bool>(detail::translate_exception<ExceptionType,Translate>(), _1, _2, translate)
        );
}
