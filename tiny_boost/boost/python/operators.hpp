...
using abt_boost::python::self_ns::abs;
using abt_boost::python::self_ns::int_;
using abt_boost::python::self_ns::long_;
using abt_boost::python::self_ns::float_;
using abt_boost::python::self_ns::complex_;
using abt_boost::python::self_ns::str;
using abt_boost::python::self_ns::repr;
using abt_boost::python::self_ns::pow;
# endif
