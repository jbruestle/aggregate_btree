...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace python { namespace container_utils {
    ...
    extend_container(Container& container, object l)
    {
        ...
        BOOST_FOREACH(object elem,
            std::make_pair(
              abt_boost::python::stl_input_iterator<object>(l),
              abt_boost::python::stl_input_iterator<object>()
              ))
        {
...
}}} // namespace abt_boost::python::container_utils
