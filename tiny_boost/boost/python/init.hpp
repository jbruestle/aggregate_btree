...
namespace detail
{
  ...
  //
    ...
    private:
        ...
        static abt_boost::type_traits::yes_type f(optional<BOOST_PYTHON_OVERLOAD_ARGS>);
        static abt_boost::type_traits::no_type f(...);
        static T t();
    ...
    public:
        ...
        BOOST_STATIC_CONSTANT(
            bool, value =
                sizeof(f(t())) == sizeof(::abt_boost::type_traits::yes_type));
