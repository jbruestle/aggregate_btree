...
template <class T>
inline typeinfo msvc_typeid(abt_boost::type<T>*)
{
    return detail::typeid_ref(
        (abt_boost::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(abt_boost::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((abt_boost::type<char const[3]>*)0)
        , msvc_typeid((abt_boost::type<char[3]>*)0);
}
#  endif
