...
# else
#  define BOOST_PYTHON_BEGIN_CONVERSION_NAMESPACE namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace python {
#  define BOOST_PYTHON_END_CONVERSION_NAMESPACE }} // namespace abt_boost::python
#  define BOOST_PYTHON_CONVERSION abt_boost::python
...
//
#define BOOST_LIB_NAME abt_boost_python
//
