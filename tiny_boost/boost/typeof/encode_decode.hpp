...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace abt_boost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER abt_boost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER abt_boost::type_of
