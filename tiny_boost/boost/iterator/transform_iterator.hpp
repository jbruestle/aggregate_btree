...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public abt_boost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    abt_boost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
