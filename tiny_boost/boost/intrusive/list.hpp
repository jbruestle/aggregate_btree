   ...
   :  private detail::clear_on_destructor_base< list_impl<Config> >
{
   ...
   typedef abt_boost::intrusive::detail::reverse_iterator<iterator>      reverse_iterator;
   typedef abt_boost::intrusive::detail::reverse_iterator<const_iterator>const_reverse_iterator;
   ...
   list_impl(BOOST_RV_REF(list_impl) x)
      : data_(::abt_boost::move(x.priv_value_traits()))
   {
      this->priv_size_traits().set_size(size_type(0));
      node_algorithms::init_header(this->get_root_node());  
      this->swap(x);
   ...
   static list_impl &priv_container_from_end_iterator(const const_iterator &end_iterator)
   {
      root_plus_size *r = detail::parent_from_member<root_plus_size, node>
         ( abt_boost::intrusive::detail::to_raw_pointer(end_iterator.pointed_node()), &root_plus_size::root_);
   ...
   >::type
{
   ...
   list(BOOST_RV_REF(list) x)
      :  Base(::abt_boost::move(static_cast<Base&>(x)))
   {}

   list& operator=(BOOST_RV_REF(list) x)
   {  this->Base::operator=(::abt_boost::move(static_cast<Base&>(x))); return *this;  }
