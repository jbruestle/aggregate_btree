...
// sample.h
   ...
   #define BOOST_INTRUSIVE_DETAIL_HAS_MEMBER_FUNCTION_CALLABLE_WITH_DETAILS_INCLUDED
      ...
      namespace abt_boost_intrusive_has_member_function_callable_with {
   ...
   #error "BOOST_PP_ITERATION_START() must be zero (0)"
      ...
      class BOOST_PP_CAT(has_member_function_named_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)
      {
         ...
         template <typename U>
         static abt_boost_intrusive_has_member_function_callable_with::no_type  deduce
            (U*, Helper<void (BaseMixin::*)(), &U::BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME>* = 0);
         static abt_boost_intrusive_has_member_function_callable_with::yes_type deduce(...);

         public:
         static const bool value =
            sizeof(abt_boost_intrusive_has_member_function_callable_with::yes_type) == sizeof(deduce((Base*)(0)));
      };
         ...
         //!
            ...
            template< class F
                  , std::size_t N = 
                        sizeof((abt_boost::move_detail::declval<F>().
            ...
            {
               abt_boost_intrusive_has_member_function_callable_with::yes_type dummy;
            ...
            {
               abt_boost_intrusive_has_member_function_callable_with::no_type dummy;
               BOOST_PP_CAT(zeroarg_checker_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)(int);
            };
               ...
               <Fun, true BOOST_PP_ENUM_TRAILING(BOOST_PP_SUB(BOOST_PP_ITERATION_FINISH(), BOOST_PP_ITERATION()), BOOST_INTRUSIVE_PP_IDENTITY, void)>
            {
               ...
               template <class U> 
               static abt_boost_intrusive_has_member_function_callable_with::no_type Test(...);
               
               static const bool value = sizeof(Test< Fun >(0))
                                    == sizeof(abt_boost_intrusive_has_member_function_callable_with::yes_type);
            };
            #endif
            ...
            {
               template<class U>
               static decltype( abt_boost::move_detail::declval<Fun>().BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME()
                              , abt_boost_intrusive_has_member_function_callable_with::yes_type())
                  Test(Fun*);
            ...
            : Fun
         {
            ...
            abt_boost_intrusive_has_member_function_callable_with::private_type
            ...
            <Fun, true , Args...>
         {
            ...
            {
               typedef abt_boost_intrusive_has_member_function_callable_with::dont_care type;
            };
            ...
            static bool const value = (sizeof(abt_boost_intrusive_has_member_function_callable_with::no_type) ==
                                       sizeof(abt_boost_intrusive_has_member_function_callable_with::is_private_type
                                                ( (::abt_boost::move_detail::declval< FunWrap >().
                                          BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
                                             ( ::abt_boost::move_detail::declval<Args>()... ), 0) )
                                             )
                                       );
         };
      ...
      BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_END
            ...
            : Fun
         {
            ...
            abt_boost_intrusive_has_member_function_callable_with::private_type
               BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
                  ...
                  , abt_boost_intrusive_has_member_function_callable_with::dont_care))  const;
         };
                                  ...
                                  , void)>
         {
            ...
            (sizeof(abt_boost_intrusive_has_member_function_callable_with::no_type) ==
               sizeof(abt_boost_intrusive_has_member_function_callable_with::is_private_type
                        (  (abt_boost::move_detail::declval<FunWrap>().
                              BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
