...
#define BOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(TNAME)              \
   ...
   {                                                                       \
      ...
      static char test(int, typename X::TNAME*);                           \
                                                                           \
      template <typename X>                                                \
      static int test(abt_boost::intrusive::detail::                           \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));              \
                                                                           \
      typedef typename                                                     \
         ::abt_boost::intrusive::detail::if_c                                  \
   ...
   {                                                                       \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));              \
                                                                           \
      typedef typename                                                     \
         ::abt_boost::intrusive::detail::eval_if_c                             \
            < value                                                        \
            , ::abt_boost::intrusive::detail::identity<T>                      \
            , ::abt_boost::intrusive::detail::identity<DefaultWrap>            \
            >::type::TNAME type;                                           \
   };                                                                      \
//
...
}}}   //namespace abt_boost::intrusive::detail

#include <boost/intrusive/detail/has_member_function_callable_with.hpp>

#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME pointer_to
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEGIN namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace intrusive { namespace detail {
...
struct type_has_rebind
{
   ...
   template <typename X>
   static int test(abt_boost::intrusive::detail::LowPriorityConversion<int>, void*);
