...
//
// This must not be located in any namespace under abt_boost::math
...
template <class T>
inline bool is_nan_helper(T t, const abt_boost::true_type&)
{
#ifdef isnan
   return isnan(t);
...
template <class T>
inline bool is_nan_helper(T, const abt_boost::false_type&)
{
   return false;
}
...
inline int fpclassify_imp BOOST_NO_MACRO_EXPAND(T t, const generic_tag<true>&)
{
   ...
   if(::abt_boost::math_detail::is_nan_helper(t, ::abt_boost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(isnan)
   if(abt_boost::math_detail::is_nan_helper(t, ::abt_boost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(_MSC_VER) || defined(__BORLANDC__)
   if(::_isnan(abt_boost::math::tools::real_cast<double>(t)))
      return FP_NAN;
#endif
...
{
   return abt_boost::math::detail::fpclassify_imp(t, generic_tag<true>());
}
#endif
...
{
   return abt_boost::math::detail::isfinite_impl(t, generic_tag<true>());
}
#endif
...
{ //!< \brief return true if floating-point type t is finite.
   typedef typename detail::fp_traits<T>::type traits;
   typedef typename traits::method method;
   typedef typename abt_boost::is_floating_point<T>::type fp_tag;
...
{
   return abt_boost::math::detail::isnormal_impl(t, generic_tag<true>());
}
#endif
...
{
   return abt_boost::math::detail::isinf_impl(t, generic_tag<true>());
}
#endif
...
#ifdef isnan
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<float>(float t){ return ::abt_boost::math_detail::is_nan_helper(t, abt_boost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<double>(double t){ return ::abt_boost::math_detail::is_nan_helper(t, abt_boost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<long double>(long double t){ return ::abt_boost::math_detail::is_nan_helper(t, abt_boost::true_type()); }
#endif
