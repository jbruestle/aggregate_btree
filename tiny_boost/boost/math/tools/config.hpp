...
#include <boost/cstdint.hpp> // for abt_boost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         abt_boost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    abt_boost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  abt_boost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  abt_boost::non_type<t, v>*
...
#define BOOST_MATH_STD_USING \
   ...
   using std::log10;\
   using std::sqrt;\
   using abt_boost::math::round;\
   using abt_boost::math::iround;\
   using abt_boost::math::lround;\
   using abt_boost::math::trunc;\
   using abt_boost::math::itrunc;\
   using abt_boost::math::ltrunc;\
   using abt_boost::math::modf;
...
}} // namespace abt_boost namespace math
...
#    define BOOST_FPU_EXCEPTION_GUARD abt_boost::math::detail::fpu_guard local_guard_object;
