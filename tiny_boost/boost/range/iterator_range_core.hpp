...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return static_cast<IteratorT>( abt_boost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return static_cast<IteratorT>( abt_boost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( abt_boost::begin(l),
                                                 abt_boost::end(l),
                                                 abt_boost::begin(r),
                                                 abt_boost::end(r) );
        }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                abt_boost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        private: // for return value of operator()()
            typedef BOOST_DEDUCED_TYPENAME
                abt_boost::mpl::if_< abt_boost::is_abstract<value_type>,
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( abt_boost::begin( r ), abt_boost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = abt_boost::begin( r ),
                    new_end   = abt_boost::end( r );
        ...
        */
        ...
        {
            return SeqT( abt_boost::begin( r ), abt_boost::end( r ) );
        }
