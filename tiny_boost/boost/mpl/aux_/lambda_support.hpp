...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::abt_boost::mpl::aux::yes_tag operator|( \
      ::abt_boost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::abt_boost::mpl::aux::no_tag operator|( \
      ::abt_boost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::abt_boost::mpl::na) >* \
    ); \
/**/
...
::abt_boost::mpl::aux::yes_tag operator|( \
      ::abt_boost::mpl::aux::has_rebind_tag<int> \
    , ::abt_boost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
