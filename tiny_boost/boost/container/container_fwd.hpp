...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace container{ namespace container_detail{

namespace bi = abt_boost::intrusive;
...
}}  //namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace container {
