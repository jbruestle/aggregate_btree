...
public:
   ...
   */
  packed_iarchive(MPI_Comm const & comm, buffer_type & b, unsigned int flags = abt_boost::archive::no_header, int position = 0)
...
BOOST_BROKEN_COMPILER_TYPE_TRAITS_SPECIALIZATION(abt_boost::mpi::packed_iarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::packed_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(abt_boost::mpi::packed_iarchive)
