...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace python { namespace api {    \
...
namespace detail {
  ...
  {
  public:
    typedef abt_boost::function3<void, OArchiver&, const object&, const unsigned int>
      saver_t;
    typedef abt_boost::function3<void, IArchiver&, object&, const unsigned int>
      loader_t;
...
void 
save_impl(Archiver& ar, const abt_boost::python::object& obj, 
          const unsigned int /*version*/,
          mpl::false_ /*has_direct_serialization*/)
{
  abt_boost::python::str py_string = abt_boost::python::pickle::dumps(obj);
  int len = abt_boost::python::extract<int>(py_string.attr("__len__")());
  const char* string = abt_boost::python::extract<const char*>(py_string);
  ar << len << abt_boost::serialization::make_array(string, len);
}
...
template<typename Archiver>
void 
load_impl(Archiver& ar, abt_boost::python::object& obj, 
          const unsigned int /*version*/, 
          mpl::false_ /*has_direct_serialization*/)
{
  int len;
  ...
  ar >> abt_boost::serialization::make_array(string.get(), len);
  abt_boost::python::str py_string(string.get(), len);
  obj = abt_boost::python::pickle::loads(py_string);
}
...
template<typename Archiver>
void 
save(Archiver& ar, const abt_boost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver OArchiver;
  typedef typename input_archiver<OArchiver>::type IArchiver;
...
template<typename Archiver>
void 
load(Archiver& ar, abt_boost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver IArchiver;
  typedef typename output_archiver<IArchiver>::type OArchiver;
...
inline void 
serialize(Archive& ar, abt_boost::python::object& obj, const unsigned int version)
{
  abt_boost::serialization::split_free(ar, obj, version);
}

} } // end namespace abt_boost::python

/************************************************************************
 * Boost.MPI-Specific Section                                           *
 ************************************************************************/
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace mpi {
 class packed_iarchive;
 class packed_oarchive;
} } // end namespace abt_boost::mpi

BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(
  ::abt_boost::mpi::packed_iarchive,
  ::abt_boost::mpi::packed_oarchive)

namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace mpi { namespace python {

template<typename T>
void
register_serialized(const T& value, PyTypeObject* type)
{
  using abt_boost::python::register_serialized;
  register_serialized<packed_iarchive, packed_oarchive>(value, type);
}

} } } // end namespace abt_boost::mpi::python
