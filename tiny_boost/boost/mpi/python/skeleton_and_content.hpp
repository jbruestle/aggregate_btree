 ...
 */
class content : public abt_boost::mpi::content
{
  typedef abt_boost::mpi::content inherited;

 public:
  content(const inherited& base, abt_boost::python::object object) 
    : inherited(base), object(object) { }

  inherited&       base()       { return *this; }
  const inherited& base() const { return *this; }

  abt_boost::python::object object;
};
...
{
public:
  skeleton_proxy_base(const abt_boost::python::object& object) : object(object) { }
...
{
 public:
  skeleton_proxy(const abt_boost::python::object& object) 
    : skeleton_proxy_base(object) { }
};

namespace detail {
  using abt_boost::python::object;
  using abt_boost::python::extract;
   
  extern BOOST_MPI_DECL abt_boost::python::object skeleton_proxy_base_type;
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(abt_boost::mpi::get_content(value), value_obj);
    }
  };
...
{
  using abt_boost::python::detail::direct_serialization_table;
  using abt_boost::python::detail::get_direct_serialization_table;
  using namespace abt_boost::python;
  ...
  {
    abt_boost::python::scope proxy_scope(detail::skeleton_proxy_base_type);
