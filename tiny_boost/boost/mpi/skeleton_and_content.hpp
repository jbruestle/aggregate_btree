...
namespace detail {
  ...
  class BOOST_MPI_DECL mpi_datatype_holder : public abt_boost::noncopyable
  {
  public:
    mpi_datatype_holder()
     : is_committed(false)
...
private:
  abt_boost::shared_ptr<detail::mpi_datatype_holder> holder;
};
...
public:
  ...
  packed_skeleton_iarchive(MPI_Comm const & comm,
                           unsigned int flags =  abt_boost::archive::no_header)
  ...
  explicit packed_skeleton_iarchive(packed_iarchive & archive)
         ...
         , skeleton_archive_(MPI_COMM_WORLD, abt_boost::archive::no_header)
        {}
...
namespace detail {
  typedef abt_boost::mpi::detail::forward_skeleton_oarchive<abt_boost::mpi::packed_skeleton_oarchive,abt_boost::mpi::packed_oarchive> type1;
  typedef abt_boost::mpi::detail::forward_skeleton_iarchive<abt_boost::mpi::packed_skeleton_iarchive,abt_boost::mpi::packed_iarchive> type2;
}
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::packed_skeleton_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::packed_skeleton_iarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::detail::type1)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::detail::type2)

BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(abt_boost::mpi::packed_skeleton_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(abt_boost::mpi::packed_skeleton_iarchive)
