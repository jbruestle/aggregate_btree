...
public:
   ...
   *  default flags.
   */
  packed_oarchive( MPI_Comm const & comm, buffer_type & b, unsigned int flags = abt_boost::archive::no_header)
         : oprimitive(b,comm),
   ...
   *  default flags.
   */
  packed_oarchive ( MPI_Comm const & comm, unsigned int flags =  abt_boost::archive::no_header)
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::packed_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(abt_boost::mpi::packed_oarchive)
