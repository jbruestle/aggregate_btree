...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace mpi { namespace detail {
...
public:
    ...
    {
      save_enum(t,abt_boost::is_enum<T>());
    }
    ...
    void save_enum(T const& t, mpl::true_)
    {
      ...
      typedef typename abt_boost::uint_t<8*sizeof(T)>::least int_type;
...
} } } // end namespace abt_boost::mpi::detail

// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::detail::mpi_datatype_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::detail::ignore_skeleton_oarchive<abt_boost::mpi::detail::mpi_datatype_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(abt_boost::mpi::detail::mpi_datatype_oarchive)
