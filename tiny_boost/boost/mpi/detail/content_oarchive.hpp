...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::detail::content_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::mpi::detail::ignore_skeleton_oarchive<abt_boost::mpi::detail::content_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(abt_boost::mpi::detail::content_oarchive)
