...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(abt_boost::long_long_type)(abt_boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (abt_boost::long_long_type)(abt_boost::ulong_long_type)
