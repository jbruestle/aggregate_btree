...
struct vertex_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename abt_boost::vertex_property_type<BidirectionalGraph>::type type;
};

template <class BidirectionalGraph, class GraphRef>
struct edge_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename abt_boost::edge_property_type<BidirectionalGraph>::type type;
};

template <class BidirectionalGraph, class GraphRef>
struct graph_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename abt_boost::graph_property_type<BidirectionalGraph>::type type;
};
...
template<typename BidirectionalGraph, typename GRef, typename Tag>
inline
typename abt_boost::mpl::if_<
           abt_boost::is_const<typename abt_boost::remove_reference<GRef>::type>,
