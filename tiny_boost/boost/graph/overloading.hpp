...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{  namespace graph { namespace detail {

struct no_parameter {};

} } } // end namespace abt_boost::graph::detail
...
#define BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph, Tag)                   \
  , BOOST_GRAPH_ENABLE_IF_MODELS(Graph, Tag,                            \
                                 ::abt_boost::graph::detail::no_parameter)  \
    = ::abt_boost::graph::detail::no_parameter()
