...
//
// It is needed in order to allow us to write using abt_boost::vertices as
...
typename T::ThereReallyIsNoMemberByThisNameInT vertices(T const&);
        ...
        : MutableGraph<G>
    {
        ...
        typename abt_boost::graph_traits<G>::vertex_descriptor u;
        typename abt_boost::graph_traits<G>::out_edge_iterator iter;
    };
...
using abt_boost::concepts::MultiPassInputIteratorConcept;

// Graph concepts
using abt_boost::concepts::GraphConcept;
using abt_boost::concepts::IncidenceGraphConcept;
using abt_boost::concepts::BidirectionalGraphConcept;
using abt_boost::concepts::AdjacencyGraphConcept;
using abt_boost::concepts::VertexListGraphConcept;
using abt_boost::concepts::EdgeListGraphConcept;
using abt_boost::concepts::VertexAndEdgeListGraphConcept;
using abt_boost::concepts::EdgeMutableGraphConcept;
using abt_boost::concepts::VertexMutableGraphConcept;
using abt_boost::concepts::MutableGraphConcept;
using abt_boost::concepts::MutableIncidenceGraphConcept;
using abt_boost::concepts::MutableBidirectionalGraphConcept;
using abt_boost::concepts::MutableEdgeListGraphConcept;
using abt_boost::concepts::VertexMutablePropertyGraphConcept;
using abt_boost::concepts::EdgeMutablePropertyGraphConcept;
using abt_boost::concepts::AdjacencyMatrixConcept;
using abt_boost::concepts::ReadablePropertyGraphConcept;
using abt_boost::concepts::PropertyGraphConcept;
using abt_boost::concepts::LvaluePropertyGraphConcept;
using abt_boost::concepts::VertexIndexGraphConcept;
using abt_boost::concepts::EdgeIndexGraphConcept;

// Utility concepts
using abt_boost::concepts::ColorValueConcept;
using abt_boost::concepts::BasicMatrixConcept;
using abt_boost::concepts::NumericValueConcept;
using abt_boost::concepts::DistanceMeasureConcept;
using abt_boost::concepts::DegreeMeasureConcept;
