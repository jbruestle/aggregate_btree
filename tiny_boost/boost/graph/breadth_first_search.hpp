...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    while (! Q.empty()) {
      ...
      for (abt_boost::tie(ei, ei_end) = out_edges(u, g); ei != ei_end; ++ei) {
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    typedef typename property_traits<ColorMap>::value_type ColorValue;
    typedef color_traits<ColorValue> Color;
    typename abt_boost::graph_traits<VertexListGraph>::vertex_iterator i, i_end;
    for (abt_boost::tie(i, i_end) = vertices(g); i != i_end; ++i) {
  ...
  public:
    ...
    {
      invoke_visitors(m_vis, u, g, ::abt_boost::on_initialize_vertex());
    ...
    {
      invoke_visitors(m_vis, u, g, ::abt_boost::on_discover_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, u, g, ::abt_boost::on_examine_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::abt_boost::on_examine_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::abt_boost::on_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::abt_boost::on_non_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::abt_boost::on_gray_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::abt_boost::on_black_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, u, g, ::abt_boost::on_finish_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
  ...
  namespace detail {
                                    ...
                                    void)* = 0)
    {
      ...
      typedef abt_boost::queue<Vertex> queue_t;
      queue_t Q;
      breadth_first_search
        (g, s,
         choose_param(get_param(params, buffer_param_t()), abt_boost::ref(Q)).get(),
         vis, color);
    }
     ...
     const bgl_named_params<P, T, R>& params)
  {
    ...
    typedef abt_boost::queue<vertex_descriptor> queue_t;
    queue_t Q;
