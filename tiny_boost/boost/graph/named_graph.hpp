...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace graph {
...
public:
  ...
  VertexProperty operator()(const vertex_name_type& name)
  {
      abt_boost::throw_exception(std::runtime_error("add_vertex: "
...
namespace detail {
  ...
  {
    typedef abt_boost::detail::error_property_not_found type;
  };
}
      ...
      typename named_vertices_type::ctor_args_list(
        abt_boost::make_tuple(
          abt_boost::make_tuple(
            ...
            abt_boost::hash<vertex_name_type>(),
