...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
  ...
  namespace detail {
    ...
    {
      abt_boost::graph_detail::erase_if(el, detail::target_is<vertex_descriptor>(v));
    }
    // O(log(E/V))
    template <class EdgeList, class vertex_descriptor>
    void erase_from_incidence_list(EdgeList& el, vertex_descriptor v,
    ...
    template <class Vertex>
    class stored_edge
      : public abt_boost::equality_comparable1< stored_edge<Vertex>,
        abt_boost::less_than_comparable1< stored_edge<Vertex> > >
    {
    public:
      ...
      const detail::stored_ra_edge_iter<Vertex, EdgeVec, Property>& e)
  {
    ...
    namespace detail {
      ...
      remove_directed_edge_if_dispatch(incidence_iterator first,
                                       ...
                                       abt_boost::allow_parallel_edge_tag)
      {
        // remove_if
      ...
      remove_directed_edge_if_dispatch(incidence_iterator first,
                                       ...
                                       EdgeList& el,
                                       Predicate pred,
                                       abt_boost::disallow_parallel_edge_tag)
      {
                       ...
                       directed_graph_helper<Config>& g_)
    {
      ...
      abt_boost::tie(first, last) = out_edges(u, g);
    ...
    remove_edge_if(Predicate pred, directed_graph_helper<Config>& g_)
    {
      ...
      for (abt_boost::tie(vi, vi_end) = vertices(g); vi != vi_end; ++vi)
                 ...
                 directed_graph_helper<Config>& g_)
    {
      ...
      for (abt_boost::tie(vi, viend) = vertices(g); vi != viend; ++vi)
             ...
             directed_graph_helper<Config>& g_)
    {
      ...
      bool inserted;
      abt_boost::tie(i, inserted) = abt_boost::graph_detail::push(g.out_edge_list(u),
                                            StoredEdge(v, p));
    ...
    namespace detail {
      ...
      remove_edge_and_property(Graph& g, EdgeList& el, Vertex v,
                               abt_boost::allow_parallel_edge_tag cat)
      {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same<EdgeListS, vecS>::value));
        ...
        for (; i != end; ++i) {
          if ((*i).get_target() == v) {
            ...
            bool skip = (abt_boost::next(i) != end && i->get_iter() == abt_boost::next(i)->get_iter());
    ...
    struct list_edge // short name due to VC++ truncation and linker problems
      : public abt_boost::detail::edge_base<abt_boost::undirected_tag, Vertex>
    {
      typedef EdgeProperty property_type;
      typedef abt_boost::detail::edge_base<abt_boost::undirected_tag, Vertex> Base;
    ...
    remove_edge_if(Predicate pred, undirected_graph_helper<Config>& g_)
    {
      ...
      abt_boost::tie(ei, ei_end) = edges(g);
             ...
             undirected_graph_helper<Config>& g_)
    {
      ...
      if (inserted) {
        abt_boost::graph_detail::push(g.out_edge_list(v), StoredEdge(u, p_iter, &g.m_edges));
                       ...
                       bidirectional_graph_helper_with_property<Config>& g_)
    {
      ...
      for (abt_boost::tie(out_i, out_end) = out_edges(u, g); out_i != out_end; ++out_i)
        if (pred(*out_i)) {
          detail::remove_directed_edge_dispatch
                      ...
                      bidirectional_graph_helper_with_property<Config>& g_)
    {
      ...
      for (abt_boost::tie(in_i, in_end) = in_edges(v, g); in_i != in_end; ++in_i)
        if (pred(*in_i)) {
      ...
      abt_boost::tie(first, last) = in_edges(v, g);
      typedef typename Config::edge_parallel_category Cat;
      detail::remove_directed_edge_if_dispatch
             ...
             bidirectional_graph_helper_with_property<Config>& g_)
    {
      ...
      abt_boost::tie(i, inserted) = abt_boost::graph_detail::push(g.out_edge_list(u),
                                        StoredEdge(v, p_iter, &g.m_edges));
      if (inserted) {
        abt_boost::graph_detail::push(in_edge_list(g, v), StoredEdge(u, p_iter, &g.m_edges));
                          ...
                          const adj_list_helper<Config, Base>& g_)
    {
      ...
      typedef typename Config::inv_adjacency_iterator inv_adjacency_iterator;
      typename Config::in_edge_iterator first, last;
      abt_boost::tie(first, last) = in_edges(u, g);
               ...
               const adj_list_helper<Config, Base>& g_)
    {
      ...
      abt_boost::tie(first, last) = graph_detail::
    ...
    namespace detail {
      ...
      inline
      typename abt_boost::property_map<typename Config::graph_type,
        Property>::type
      get_dispatch(adj_list_helper<Config,Base>&, Property,
                   abt_boost::edge_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename abt_boost::property_map<Graph, Property>::type PA;
        return PA();
      }
      template <class Config, class Base, class Property>
      inline
      ...
      get_dispatch(const adj_list_helper<Config,Base>&, Property,
                   abt_boost::edge_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename abt_boost::property_map<Graph, Property>::const_type PA;
        return PA();
      }
    ...
    template <class Config, class Base, class Property>
    inline
    typename abt_boost::property_map<typename Config::graph_type, Property>::type
    ...
    inline
    typename abt_boost::property_traits<
      typename abt_boost::property_map<typename Config::graph_type,
        Property>::type
    >::reference
    ...
    {
      typedef typename Config::graph_type Graph;
      typedef typename abt_boost::property_map<Graph, Property>::type Map;
    ...
    public:
      ...
      inline void copy_impl(const adj_list_impl& x_)
      {
        ...
        for (abt_boost::tie(vi, vi_end) = vertices(x); vi != vi_end; ++vi) {
        ...
        for (abt_boost::tie(ei, ei_end) = edges(x); ei != ei_end; ++ei) {
          edge_descriptor e;
          bool inserted;
          vertex_descriptor s = source(*ei,x), t = target(*ei,x);
          abt_boost::tie(e, inserted) = add_edge(vertex_map[(stored_vertex*)s],
    ...
    add_vertex(adj_list_impl<Derived, Config, Base>& g_)
    {
      ...
      bool inserted;
      abt_boost::tie(pos,inserted) = abt_boost::graph_detail::push(g.m_vertices, v);
      v->m_position = pos;
      g.added_vertex(v);
      return v;
    }
    ...
    public:
      ...
      //    protected:
      inline abt_boost::integer_range<vertex_descriptor> vertex_set() const {
        return abt_boost::integer_range<vertex_descriptor>(0, m_vertices.size());
      }
      inline OutEdgeList& out_edge_list(vertex_descriptor v) {
      ...
      inline void copy_impl(const vec_adj_list_impl& x_)
      {
        ...
        for (abt_boost::tie(ei, ei_end) = edges(x); ei != ei_end; ++ei) {
          edge_descriptor e;
          bool inserted;
          abt_boost::tie(e, inserted) = add_edge(source(*ei,x), target(*ei,x) , *this);
          *((edge_property_type*)e.m_eproperty)
            = *((edge_property_type*)(*ei).m_eproperty);
        }
      }
  ...
  namespace detail {
    ...
    struct adj_list_gen
    {
      ...
      struct config
      {
        ...
        typedef abt_boost::integer_range<vertex_descriptor> RandVertexList;
        ...
        typedef abt_boost::detail::iterator_traits<OutEdgeIter> OutEdgeIterTraits;
        ...
        typedef abt_boost::detail::iterator_traits<EdgeIter> EdgeIterTraits;
    ...
    struct adj_list_vertex_property_map
      : public abt_boost::put_get_helper<
          Reference,
        ...
        >
    {
      ...
      typedef abt_boost::lvalue_property_map_tag category;
    ...
    struct adj_list_vertex_all_properties_map
      : public abt_boost::put_get_helper<PropRef,
        ...
        >
    {
      typedef ValueType value_type;
      typedef Reference reference;
      typedef typename abt_boost::graph_traits<Graph>::vertex_descriptor key_type;
      typedef abt_boost::lvalue_property_map_tag category;
    ...
    struct vec_adj_list_vertex_all_properties_map
      : public abt_boost::put_get_helper<PropertyRef,
        ...
        >
    {
      ...
      typedef abt_boost::readable_property_map_tag category;
...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
  ...
  template <typename V>
  struct hash< abt_boost::detail::stored_edge<V> >
  {
    std::size_t
    operator()(const abt_boost::detail::stored_edge<V>& e) const
    {
  ...
  struct hash< abt_boost::detail::stored_edge_property <V,P> >
  {
    std::size_t
    operator()(const abt_boost::detail::stored_edge_property<V,P>& e) const
    {
      return hash<V>()(e.m_target);
    }
  };
  ...
  struct hash< abt_boost::detail::stored_edge_iter<V,I, P> >
  {
    std::size_t
    operator()(const abt_boost::detail::stored_edge_iter<V,I,P>& e) const
    {
      return hash<V>()(e.m_target);
    }
  };
