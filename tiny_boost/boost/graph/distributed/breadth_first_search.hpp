...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
  namespace detail {
    ...
    {
      using abt_boost::graph::parallel::process_group;

      typedef graph_traits<DistributedGraph> Traits;
      typedef typename Traits::vertex_descriptor Vertex;
      typedef typename abt_boost::graph::parallel::process_group_type<DistributedGraph>::type 
        process_group_type;
      ...
      typedef abt_boost::graph::distributed::distributed_queue<
