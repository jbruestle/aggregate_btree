...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
  ...
  struct container_gen<hash_setS, ValueType> {
    typedef abt_boost::unordered_set<ValueType> type;
  };
  ...
  struct container_gen<hash_multisetS, ValueType> {
    typedef abt_boost::unordered_multiset<ValueType> type;
  };
  ...
  struct hash_setS {
    template <class T>
    struct bind_ { typedef abt_boost::unordered_set<T> type; };
  };
  ...
  struct hash_multisetS {
    template <class T>
    struct bind_ { typedef abt_boost::unordered_multiset<T> type; };
  };
