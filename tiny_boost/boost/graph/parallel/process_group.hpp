...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace graph { namespace parallel {
...
} } } // end namespace abt_boost::graph::parallel

namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace graph { namespace distributed {
...
} } } // end namespace abt_boost::graph::distributed
