...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace parameter {
...
# define BOOST_PARAMETER_KEYWORD(tag_namespace,name)                    \
    ...
    static ::abt_boost::parameter::keyword<tag_namespace::name> const& name \
       = ::abt_boost::parameter::keyword<tag_namespace::name>::instance;
...
#define BOOST_PARAMETER_KEYWORD(tag_namespace,name)                 \
    ...
    namespace                                                       \
    {                                                               \
       ::abt_boost::parameter::keyword<tag_namespace::name> const& name \
       = ::abt_boost::parameter::keyword<tag_namespace::name>::instance;\
    }

#endif

}} // namespace abt_boost::parameter
