...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ template<class T> class reference_wrapper; }
...
// Can't use abt_boost::unwrap_reference<> here because it
