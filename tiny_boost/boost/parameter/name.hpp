...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{ namespace parameter { namespace aux {
...
}}} // namespace abt_boost::parameter::aux
...
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    static ::abt_boost::parameter::keyword<tag> const& name             \
       = ::abt_boost::parameter::keyword<tag>::instance;
# else
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    namespace                                                       \
    {                                                               \
       ::abt_boost::parameter::keyword<tag> const& name                 \
       = ::abt_boost::parameter::keyword<tag>::instance;                \
    }
# endif
      ...
      {                                                             \
          ...
          {                                                         \
              return BOOST_PP_STRINGIZE(tag);                       \
                                                                    ...
                                                                    \
          typedef abt_boost::parameter::value_type<                     \
              abt_boost::mpl::_2, tag, abt_boost::parameter::void_          \
          > _;                                                      \
                                                                    \
          typedef abt_boost::parameter::value_type<                     \
              abt_boost::mpl::_2, tag, abt_boost::parameter::void_          \
...
# define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                     \
    ...
    template <class T>                                              \
    struct name                                                     \
      : abt_boost::parameter::template_keyword<tag::name, T>            \
    {};                                                             \
/**/
