...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct Integer< ::abt_boost::long_long_type> {};
  template <> struct Integer< ::abt_boost::ulong_long_type> {};
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct SignedInteger< ::abt_boost::long_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct UnsignedInteger< ::abt_boost::ulong_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
#define BOOST_DEFINE_BINARY_OPERATOR_CONSTRAINT(OP,NAME)    \
  ...
  BOOST_concept(Generator,(Func)(Return))
  {
   ...
   private:
      void test(abt_boost::mpl::false_)
      {
  ...
  BOOST_concept(UnaryFunction,(Func)(Return)(Arg))
  {
   ...
   private:
      ...
      // (warning: non-static reference "const double& abt_boost::UnaryFunction<YourClassHere>::arg"
  ...
  BOOST_concept(BinaryFunction,(Func)(Return)(First)(Second))
  {
   ...
   private:
      ...
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& abt_boost::BinaryFunction<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryFunction();
#endif
  ...
  BOOST_concept(UnaryPredicate,(Func)(Arg))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& abt_boost::UnaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      UnaryPredicate();
#endif
  ...
  BOOST_concept(BinaryPredicate,(Func)(First)(Second))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& abt_boost::BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryPredicate();
#endif
    Func f;
    ...
    : BinaryPredicate<Func, First, Second>
  {
   ...
   private:
    void const_constraints(const Func& fun) {
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& abt_boost::Const_BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
  ...
  {
      typedef typename abt_boost::detail::iterator_traits<TT>::value_type value_type;
      typedef typename abt_boost::detail::iterator_traits<TT>::difference_type difference_type;
      typedef typename abt_boost::detail::iterator_traits<TT>::reference reference;
      typedef typename abt_boost::detail::iterator_traits<TT>::pointer pointer;
      typedef typename abt_boost::detail::iterator_traits<TT>::iterator_category iterator_category;
    ...
    , Comparable<TT>
  {
   ...
   private:
    TT a, b;
    TT i, j;
      typename abt_boost::detail::iterator_traits<TT>::difference_type n;
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(SimpleAssociativeContainer)
      {
          typedef typename C::key_type key_type;
          typedef typename C::value_type value_type;
          BOOST_MPL_ASSERT((abt_boost::is_same<key_type,value_type>));
      }
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(PairAssociativeContainer)
      {
          ...
          BOOST_MPL_ASSERT((abt_boost::is_same<value_type,required_value_type>));
      }
  };
  ...
  BOOST_concept(Collection,(C))
  {
      ...
      {
        abt_boost::function_requires<abt_boost::InputIteratorConcept<iterator> >();
        abt_boost::function_requires<abt_boost::InputIteratorConcept<const_iterator> >();
        abt_boost::function_requires<abt_boost::CopyConstructibleConcept<value_type> >();
        const_constraints(c);
        i = c.begin();
        i = c.end();
        c.swap(c);
