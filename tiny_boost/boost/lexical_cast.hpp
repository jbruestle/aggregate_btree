...
#       warning "Unable to use <locale> header. abt_boost::lexical_cast will use the 'C' locale."
...
namespace abt_boost{} namespace boost = abt_boost; namespace abt_boost{
...
#if !defined(__SUNPRO_CC)
    template<class CharT, class Traits, class Alloc>
    struct stream_char< ::abt_boost::container::basic_string<CharT,Traits,Alloc> >
    {
        typedef CharT type;
    };
#endif // !defined(__SUNPRO_CC)
    ...
    struct stream_char<const char32_t *>
    {
        ...
        struct widest_char
        {
            typedef BOOST_DEDUCED_TYPENAME abt_boost::mpl::if_c<
    ...
    namespace detail // deduce_char_traits template
    {
        ...
        template<class CharT, class Traits, class Alloc, class Source>
        struct deduce_char_traits< CharT
                                 , ::abt_boost::container::basic_string<CharT,Traits,Alloc>
                                 , Source
                                 >
        {
            typedef Traits type;
        ...
        template<class CharT, class Traits, class Alloc1, class Alloc2>
        struct deduce_char_traits< CharT
                                 , ::abt_boost::container::basic_string<CharT,Traits,Alloc1>
                                 , ::abt_boost::container::basic_string<CharT,Traits,Alloc2>
                                 >
        {
            typedef Traits type;
        };
...
#define BOOST_LCAST_DEF(T)               \
    ...
    { static void check_coverage() {} };
        ...
        BOOST_LCAST_DEF(abt_boost::ulong_long_type)
        BOOST_LCAST_DEF(abt_boost::long_long_type )
...
# pragma option pop
    ...
    namespace detail // lcast_put_unsigned
    {
        ...
        CharT* lcast_put_unsigned(const T n_param, CharT* finish)
        {
            ...
            BOOST_DEDUCED_TYPENAME abt_boost::mpl::if_c<
    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace)
        {
            ...
            if( !memcmp(begin, lc_nan, 3*sizeof(CharT)) || !memcmp(begin, lc_NAN, 3*sizeof(CharT)) )
            {
                ...
                else value = (abt_boost::math::changesign) (std::numeric_limits<T>::quiet_NaN());
                return true;
            } else
            if (( /* 'INF' or 'inf' */
                  end-begin==3
             ...
             )
            {
                ...
                else value = (abt_boost::math::changesign) (std::numeric_limits<T>::infinity());
                return true;
            }
        ...
        {
            using namespace std;
            if ( (abt_boost::math::isnan)(value) )
            {
                if ( (abt_boost::math::signbit)(value) )
                {
                ...
                return true;
            } else if ( (abt_boost::math::isinf)(value) )
            {
                if ( (abt_boost::math::signbit)(value) )
                {
    ...
    namespace detail // lcast_ret_float
    {
        ...
        {
#if defined(BOOST_HAS_LONG_LONG)
            typedef abt_boost::ulong_long_type type;
#elif defined(BOOST_HAS_MS_INT64)
        ...
        inline bool lcast_ret_float(T& value, const CharT* begin, const CharT* end)
        {
            ...
            value = static_cast<T>( has_minus ? (abt_boost::math::changesign)(result) : result);

            if ( (abt_boost::math::isinf)(value) || (abt_boost::math::isnan)(value) ) return false;
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch)
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "abt_boost::lexical_cast does not support conversions from whar_t to char types."
                    "Use abt_boost::locale instead" );
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
                std::locale loc;
            ...
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)),
                    "abt_boost::lexical_cast does not support conversions from wchar_t to char types."
                    "Use abt_boost::locale instead" );
...
# pragma warning( disable : 4996 )
            ...
            {   using namespace std;
                ...
                finish = start + sprintf(out,"%.*g", static_cast<int>(abt_boost::detail::lcast_get_precision<float >()), val );
                return finish > start;
            }
            ...
            {   using namespace std;
                if (put_inf_nan(start,finish,val)) return true;
                finish = start + sprintf(out,"%.*lg", static_cast<int>(abt_boost::detail::lcast_get_precision<double >()), val );
                return finish > start;
            }
#ifndef __MINGW32__
            template <class T>
            ...
            {   using namespace std;
                if (put_inf_nan(start,finish,val)) return true;
                finish = start + sprintf(out,"%.*Lg", static_cast<int>(abt_boost::detail::lcast_get_precision<long double >()), val );
                return finish > start;
            }
#endif
...
# pragma warning( pop )
            ...
            {   using namespace std;
                ...
                finish = start + swprintf(out,
                                          ...
                                          finish-start,
#endif
                                          L"%.*g", static_cast<int>(abt_boost::detail::lcast_get_precision<float >()), val );
            ...
            {   using namespace std;
                ...
                finish = start + swprintf(out,
                                          ...
                                          finish-start,
#endif
                                          L"%.*lg", static_cast<int>(abt_boost::detail::lcast_get_precision<double >()), val );
                return finish > start;
            }
            ...
            {   using namespace std;
                ...
                finish = start + swprintf(out,
                                          ...
                                          finish-start,
#endif
                                          L"%.*Lg", static_cast<int>(abt_boost::detail::lcast_get_precision<long double >()), val );
                return finish > start;
            }
#endif
...
#if !defined(__SUNPRO_CC)
            template<class Alloc>
            bool operator<<(::abt_boost::container::basic_string<CharT,Traits,Alloc> const& str)
            {
                start = const_cast<CharT*>(str.data());
                finish = start + str.length();
                return true;
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator<<(abt_boost::ulong_long_type n)   { start = lcast_put_unsigned<Traits>(n, finish); return true; }
            bool operator<<(abt_boost::long_long_type n)    { return shl_signed(n); }
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>(abt_boost::ulong_long_type& output)     { return shr_unsigned(output); }
            bool operator>>(abt_boost::long_long_type& output)      { return shr_signed(output); }
#elif defined(BOOST_HAS_MS_INT64)
...
#if !defined(__SUNPRO_CC)
            template<class Alloc>
            bool operator>>(::abt_boost::container::basic_string<CharT,Traits,Alloc>& str) { str.assign(start, finish); return true; }
#endif // !defined(__SUNPRO_CC)
#endif
            /*
        ...
        public:
            ...
            bool operator>>(double& output)
            {
                ...
                abt_boost::mpl::if_c<
                    ...
                    ::abt_boost::type_traits::ice_eq< sizeof(double), sizeof(long double) >::value,
#else
                     0
#endif
                    int,
...
#if !defined(__SUNPRO_CC)
        template<typename CharT, typename Traits, typename Alloc>
        struct is_stdstring< ::abt_boost::container::basic_string<CharT, Traits, Alloc> >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };
#endif // !defined(__SUNPRO_CC)
            ...
            BOOST_STATIC_CONSTANT(bool, value =
                (
                    ::abt_boost::type_traits::ice_or<
                        ...
                        >::value,
                        ::abt_boost::type_traits::ice_and<
                             ::abt_boost::type_traits::ice_eq< sizeof(char),sizeof(Target)>::value,
                             ::abt_boost::type_traits::ice_eq< sizeof(char),sizeof(Source)>::value,
                             is_char_or_wchar<Target>::value,
...
#if !defined(__SUNPRO_CC)
        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_stdstring< ::abt_boost::container::basic_string<CharT, Traits, Alloc>, CharT* >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };

        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_stdstring< ::abt_boost::container::basic_string<CharT, Traits, Alloc>, const CharT* >
        {
            BOOST_STATIC_CONSTANT(bool, value = true );
        };
#endif // !defined(__SUNPRO_CC)
...
# pragma warning( disable : 4267 ) // conversion from 'size_t' to 'unsigned int'
        ...
        struct lexical_cast_do_cast
        {
            static inline Target lexical_cast_impl(const Source& arg)
            {
                ...
                (::abt_boost::type_traits::ice_or<
                    ::abt_boost::type_traits::ice_and<
                        ::abt_boost::type_traits::ice_eq<sizeof(char_type), sizeof(char) >::value,
                        ::abt_boost::type_traits::ice_or<
                            ::abt_boost::is_same<char, removed_ptr_t>::value,
                            ::abt_boost::is_same<unsigned char, removed_ptr_t>::value,
                            ::abt_boost::is_same<signed char, removed_ptr_t>::value
                        >::value
                    >::value,
...
# pragma warning( pop )
        ...
        class precision_loss_error : public abt_boost::numeric::bad_numeric_cast
        {
         public:
            virtual const char * what() const throw()
        ...
        {
         typedef abt_boost::numeric::Trunc<S> Rounder;
            ...
            static inline Target lexical_cast_impl(const Source &arg)
            {
                try{
                    typedef abt_boost::numeric::converter<
                            Target,
                            Source,
                            abt_boost::numeric::conversion_traits<Target,Source>,
                            abt_boost::numeric::def_overflow_handler,
                            throw_on_precision_loss<Source>
                    > Converter ;

                    return Converter::convert(arg);
                } catch( ::abt_boost::numeric::bad_numeric_cast const& ) {
                    BOOST_LCAST_THROW_BAD_CAST(Source, Target);
                }
         ...
         *
         *
         * Rule 2) required because abt_boost::lexical_cast has the behavior of
        ...
        struct lexical_cast_dynamic_num
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                typedef BOOST_DEDUCED_TYPENAME ::abt_boost::mpl::if_c<
                    ::abt_boost::type_traits::ice_and<
                        ::abt_boost::type_traits::ice_or<
                            ::abt_boost::is_signed<Source>::value,
                            ::abt_boost::is_float<Source>::value
                        >::value,
                        ::abt_boost::type_traits::ice_not<
                        ...
                        >::value,
                        ::abt_boost::is_unsigned<Target>::value
                    >::value,
    ...
    inline Target lexical_cast(const Source &arg)
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME ::abt_boost::type_traits::ice_or<
