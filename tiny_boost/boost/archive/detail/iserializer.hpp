...
private:
    virtual void destroy(/*const*/ void *address) const {
        abt_boost::serialization::access::destroy(static_cast<T *>(address));
    }
protected:
    // protected constructor since it's always created by singleton
    explicit iserializer() :
        basic_iserializer(
            abt_boost::serialization::singleton<
                BOOST_DEDUCED_TYPENAME 
                abt_boost::serialization::type_info_implementation< T >::type
            >::get_const_instance()
        )
    {}
public:
    ...
    virtual bool class_info() const {
        return abt_boost::serialization::implementation_level< T >::value 
            >= abt_boost::serialization::object_class_info;
    }
    virtual bool tracking(const unsigned int /* flags */) const {
        return abt_boost::serialization::tracking_level< T >::value 
                == abt_boost::serialization::track_always
            || ( abt_boost::serialization::tracking_level< T >::value 
                == abt_boost::serialization::track_selectively
                && serialized_as_pointer());
    }
    virtual version_type version() const {
        return version_type(::abt_boost::serialization::version< T >::value);
    }
    virtual bool is_polymorphic() const {
        return abt_boost::is_polymorphic< T >::value;
    }
    virtual ~iserializer(){};
};
...
BOOST_DLLEXPORT void iserializer<Archive, T>::load_object_data(
    ...
    if(file_version > static_cast<const unsigned int>(version()))
        abt_boost::serialization::throw_exception(
            archive::archive_exception(
                abt_boost::archive::archive_exception::unsupported_class_version,
                get_debug_info()
            )
        );
    #endif
    ...
    abt_boost::serialization::serialize_adl(
        abt_boost::serialization::smart_cast_reference<Archive &>(ar),
        * static_cast<T *>(x), 
        file_version
    );
}
...
private:
    virtual const basic_iserializer & get_basic_serializer() const {
        return abt_boost::serialization::singleton<
...
{
    // abt_boost::has_new_operator< T > doesn't work on these compilers
    #if DONT_USE_HAS_NEW_OPERATOR
...
public:
    ...
    ~auto_ptr_with_deleter(){
        if (m_p)
            abt_boost::serialization::access::destroy(m_p);
    }
    T* get() const {
        return m_p;
    }
...
) const
{
    ...
    if(NULL == ap.get())
        abt_boost::serialization::throw_exception(std::bad_alloc()) ;
    ...
    BOOST_TRY {
        ...
        abt_boost::serialization::load_construct_data_adl<Archive, T>(
            ar_impl,
            t, 
            file_version
        );
    ...
    ar_impl >> abt_boost::serialization::make_nvp(NULL, * t);
    ap.release();
}
...
struct load_non_pointer_type {
    ...
    struct load_only {
        ...
        static void invoke(Archive & ar, const T & t){
            ...
            abt_boost::serialization::serialize_adl(
                ar, 
                const_cast<T &>(t), 
                abt_boost::serialization::version< T >::value
            );
        }
    };
    ...
    static void invoke(Archive & ar, T &t){
        typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<
                // if its primitive
                mpl::equal_to<
                    abt_boost::serialization::implementation_level< T >,
                    mpl::int_<abt_boost::serialization::primitive_type>
                >,
            ...
            mpl::greater_equal<
                        abt_boost::serialization::implementation_level< T >,
                        mpl::int_<abt_boost::serialization::object_class_info>
                    >,
            // do standard load
        ...
        BOOST_DEDUCED_TYPENAME mpl::eval_if<
            // no tracking
                    mpl::equal_to<
                        abt_boost::serialization::tracking_level< T >,
                        mpl::int_<abt_boost::serialization::track_never>
                >,
                // do a fast load
...
struct load_pointer_type {
    struct abstract
    {
        ...
        static const basic_pointer_iserializer * register_type(Archive & /* ar */){
            ...
            BOOST_STATIC_ASSERT(abt_boost::is_polymorphic< T >::value);
    ...
    static const basic_pointer_iserializer * register_type(Archive &ar, const T & /*t*/){
        ...
        typedef BOOST_DEDUCED_TYPENAME
            mpl::eval_if<
                abt_boost::serialization::is_abstract<const T>,
                abt_boost::mpl::identity<abstract>,
                abt_boost::mpl::identity<non_abstract>  
            >::type typex;
    ...
    static T * pointer_tweak(
        const abt_boost::serialization::extended_type_info & eti,
        void const * const t,
        const T &
    ) {
        ...
        return static_cast<T *>(
            const_cast<void *>(
                abt_boost::serialization::void_upcast(
                    eti,
                    abt_boost::serialization::singleton<
                        BOOST_DEDUCED_TYPENAME 
                        abt_boost::serialization::type_info_implementation< T >::type
    ...
    find(const abt_boost::serialization::extended_type_info & type){
...
struct load_enum_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        int i;
        ar >> abt_boost::serialization::make_nvp(NULL, i);
        t = static_cast< T >(i);
    }
};
...
struct load_array_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        abt_boost::serialization::collection_size_type count;
        ar >> BOOST_SERIALIZATION_NVP(count);
        if(static_cast<std::size_t>(count) > current_count)
            abt_boost::serialization::throw_exception(
                archive::archive_exception(
                    abt_boost::archive::archive_exception::array_size_too_short
                )
            );
...
inline void load_wrapper(Archive &ar, const T&t, mpl::true_){
    abt_boost::archive::load(ar, const_cast<T&>(t));
}
