...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        abt_boost::archive::iterators::insert_linebreaks<
            abt_boost::archive::iterators::base64_from_binary<
                abt_boost::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    abt_boost::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
