...
void save_iterator(std::wostream &os, InputIterator begin, InputIterator end){
    ...
    std::copy(
        ...
        abt_boost::archive::iterators::ostream_iterator<wchar_t>(os)
    );
}
    ...
    basic_xml_oarchive<Archive>(flags)
{
    ...
    if(0 == (flags & no_codecvt)){
        abt_boost::archive::detail::utf8_codecvt_facet *pfacet;
        #if defined(__SGI_STL_PORT)
            static abt_boost::archive::detail::utf8_codecvt_facet 
                facet(static_cast<size_t>(1));
            pfacet = & facet;
        #else
            pfacet = new abt_boost::archive::detail::utf8_codecvt_facet;
        #endif
