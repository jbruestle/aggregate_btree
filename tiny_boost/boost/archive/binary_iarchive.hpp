...
class naked_binary_iarchive : 
    public binary_iarchive_impl<
        abt_boost::archive::naked_binary_iarchive, 
...
class binary_iarchive : 
    public binary_iarchive_impl<
        abt_boost::archive::binary_iarchive, 
        std::istream::char_type, 
        std::istream::traits_type
    >,
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::archive::binary_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(abt_boost::archive::binary_iarchive)
