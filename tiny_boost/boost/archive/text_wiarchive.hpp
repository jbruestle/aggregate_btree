...
protected:
    ...
    void load(abt_boost::serialization::item_version_type & t){
        unsigned int v;
        load(v);
        t = abt_boost::serialization::item_version_type(v);
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::archive::text_wiarchive)
