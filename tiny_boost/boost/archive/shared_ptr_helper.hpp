...
class shared_ptr_helper {
    ...
    typedef std::set<
        abt_boost::shared_ptr<const void>,
    ...
    struct void_deleter {
        const abt_boost::serialization::extended_type_info * m_eti;
        void_deleter(const abt_boost::serialization::extended_type_info *eti) :
            m_eti(eti)
        {}
...
#else
    template<class Archive, class T>
    friend inline void abt_boost::serialization::load(
        Archive & ar,
        abt_boost::shared_ptr< T > &t,
        const unsigned int file_version
    );
...
//  #ifdef BOOST_SERIALIZATION_SHARED_PTR_132_HPP
    ...
    std::list<abt_boost_132::shared_ptr<const void> > * m_pointers_132;
//  #endif
    ...
    get_od(
        ...
        const abt_boost::serialization::extended_type_info * this_type
    );

    BOOST_ARCHIVE_DECL(void)
    append(const abt_boost::shared_ptr<const void> &);

    template<class T>
    struct non_polymorphic {
        static const abt_boost::serialization::extended_type_info * 
...
//  #ifdef BOOST_SERIALIZATION_SHARED_PTR_132_HPP
    BOOST_ARCHIVE_DECL(void)
    append(const abt_boost_132::shared_ptr<const void> & t);
//  #endif
public:
