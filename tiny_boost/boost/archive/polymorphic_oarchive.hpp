...
public:
    ...
    virtual void save(const abt_boost::long_long_type t) = 0;
    virtual void save(const abt_boost::ulong_long_type t) = 0;
    ...
    void save_override(
                ...
                const
                #endif
                ::abt_boost::serialization::nvp< T > & t, int
        ){
        save_start(t.name());
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(abt_boost::archive::polymorphic_oarchive)
