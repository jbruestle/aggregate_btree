...
public:
    ...
    #if 0
    void save_override(const abt_boost::archive::version_type & t, int version){
        ...
        if(abt_boost::archive::library_version_type(6) < lvt){
            const abt_boost::uint_least16_t x = t;
            * this->This() << x;
        }
        else{
    ...
    void save_override(const abt_boost::serialization::item_version_type & t, int version){
        library_version_type lvt = this->get_library_version();
        if(abt_boost::archive::library_version_type(7) < lvt){
            this->detail_common_oarchive::save_override(t, version);
        }
    ...
    void save_override(class_id_type & t, int version){
        ...
        if(abt_boost::archive::library_version_type(6) < lvt){
            const abt_boost::int_least16_t x = t;
            * this->This() << x;
        }
        else{
            const int x = t;
    ...
    void save_override(const serialization::collection_size_type & t, int){
        if (get_library_version() < abt_boost::archive::library_version_type(6)){
            unsigned int x=0;
            * this->This() >> x;
