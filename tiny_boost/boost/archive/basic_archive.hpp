...
public:
    ...
    explicit library_version_type(const unsigned int & t_) : t(t_){
        BOOST_ASSERT(t_ <= abt_boost::integer_traits<base_type>::const_max);
    }
...
#define NULL_POINTER_TAG abt_boost::archive::class_id_type(-1)
...
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::library_version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::class_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::class_id_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::class_id_optional_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::class_name_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::object_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::object_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(abt_boost::archive::tracking_type, primitive_type)
...
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::library_version_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::version_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::class_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::class_id_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::class_id_optional_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::class_name_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::object_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::object_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(abt_boost::archive::tracking_type)
