...
public:
    ...
    abt_boost::scoped_ptr<std::locale> archive_locale;
...
public:
    ...
    struct use_array_optimization {
        template <class T>  
            ...
            struct apply {  
                typedef BOOST_DEDUCED_TYPENAME abt_boost::serialization::is_bitwise_serializable< T >::type type;  
            };
        #else
            struct apply : public abt_boost::serialization::is_bitwise_serializable< T > {};  
        #endif
    };
    ...
    void save_array(abt_boost::serialization::array<ValueType> const& a, unsigned int)
    {
...
basic_binary_oprimitive<Archive, Elem, Tr>::save_binary(
    ...
    count = ( count + sizeof(Elem) - 1) 
        / sizeof(Elem);
    BOOST_ASSERT(count <= std::size_t(abt_boost::integer_traits<std::streamsize>::const_max));
