...
// types.
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T const ,::abt_boost::is_lvalue_reference<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T volatile ,::abt_boost::is_lvalue_reference<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T const volatile ,::abt_boost::is_lvalue_reference<T>::value)
...
using ::abt_boost::type_traits::wrap;
...
struct is_lvalue_reference_impl
{
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(
            ::abt_boost::detail::is_lvalue_reference_helper2(
                ::abt_boost::detail::is_lvalue_reference_helper1(::abt_boost::type_traits::wrap<T>()))) == 1
        );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_lvalue_reference,T,::abt_boost::detail::is_lvalue_reference_impl<T>::value)
