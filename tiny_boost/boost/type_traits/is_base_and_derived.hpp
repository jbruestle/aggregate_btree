...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::abt_boost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::abt_boost::is_class<B>::value,
       ::abt_boost::is_class<D>::value,
       ::abt_boost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::abt_boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::abt_boost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )
