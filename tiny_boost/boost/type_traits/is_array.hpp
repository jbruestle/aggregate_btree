...
{ 
    BOOST_STATIC_CONSTANT(bool, value = 
        sizeof(::abt_boost::detail::is_array_tester2(
            ::abt_boost::detail::is_array_tester1(
                ::abt_boost::type_traits::wrap<T>()
                )
        )) == 1
    );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_array,T,::abt_boost::detail::is_array_impl<T>::value)
