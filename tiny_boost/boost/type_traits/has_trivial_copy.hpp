...
struct has_trivial_copy_impl
{
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::abt_boost::type_traits::ice_and<
         ::abt_boost::is_pod<T>::value,
         ::abt_boost::type_traits::ice_not< ::abt_boost::is_volatile<T>::value >::value
      >::value));
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy,T,::abt_boost::detail::has_trivial_copy_impl<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy_constructor,T,::abt_boost::detail::has_trivial_copy_impl<T>::value)
