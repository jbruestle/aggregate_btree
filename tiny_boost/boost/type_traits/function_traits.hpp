...
struct function_traits : 
  public abt_boost::detail::function_traits_helper<typename abt_boost::add_pointer<Function>::type>
{
};
...
struct function_traits
{
  BOOST_STATIC_CONSTANT(unsigned, arity = (sizeof(abt_boost::detail::function_arity_helper((Function*)0))-1));
};
