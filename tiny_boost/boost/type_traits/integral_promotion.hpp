...
// 4.5/2
template <class T> struct need_promotion : public abt_boost::is_enum<T> {};
...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(abt_boost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(abt_boost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, abt_boost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, abt_boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, abt_boost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, abt_boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (abt_boost::type_traits::detail::promoted_index<T>::value)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , BOOST_DEDUCED_TYPENAME
        abt_boost::type_traits::detail::integral_promotion<T>::type
    )
}
