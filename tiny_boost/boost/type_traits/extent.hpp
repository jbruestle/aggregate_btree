...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::abt_boost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::abt_boost::integral_constant<std::size_t, ::abt_boost::detail::extent_imp<T,N>::value>
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1300) 
   typedef ::abt_boost::integral_constant<std::size_t, ::abt_boost::detail::extent_imp<T,N>::value> base_; 
   using base_::value;
#endif
