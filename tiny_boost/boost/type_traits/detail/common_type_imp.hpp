 ...
 *
 * struct abt_boost::common_type<T,U>
 *
...
struct common_type_impl
    : public common_type_dispatch_on_rvalueness<T,U, sizeof( ::abt_boost::detail_type_traits_common_type::rvalue_test(
