    ...
    BOOST_STATIC_CONSTANT(
        bool, value = (
            ::abt_boost::type_traits::ice_or<
              ::abt_boost::detail::empty_helper<cvt,::abt_boost::is_class<T>::value>::value
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
           ::abt_boost::type_traits::ice_or<
              ::abt_boost::detail::empty_helper<
                  cvt
                , ::abt_boost::is_class<T>::value
                , ::abt_boost::is_convertible< r_type,int>::value
              >::value
              , BOOST_INTERNAL_IS_EMPTY(cvt)
           >::value));
};
...
struct is_empty_impl
{
   typedef ::abt_boost::detail::empty_helper_chooser<
      ::abt_boost::type_traits::ice_and<
         ::abt_boost::type_traits::ice_not< ::abt_boost::is_reference<T>::value >::value,
         ::abt_boost::type_traits::ice_not< ::abt_boost::is_convertible<T,double>::value >::value,
         ::abt_boost::type_traits::ice_not< ::abt_boost::is_pointer<T>::value >::value,
         ::abt_boost::type_traits::ice_not< ::abt_boost::is_member_pointer<T>::value >::value,
         ::abt_boost::type_traits::ice_not< ::abt_boost::is_array<T>::value >::value,
         ::abt_boost::type_traits::ice_not< ::abt_boost::is_void<T>::value >::value,
         ::abt_boost::type_traits::ice_not<
            ::abt_boost::is_convertible<T,void const volatile*>::value
            >::value
      >::value > chooser;
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::abt_boost::type_traits::ice_or<eh_type::value, BOOST_INTERNAL_IS_EMPTY(T)>::value));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_empty,T,::abt_boost::detail::is_empty_impl<T>::value)
