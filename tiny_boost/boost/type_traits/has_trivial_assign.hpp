...
struct has_trivial_assign_impl
{
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::abt_boost::type_traits::ice_and<
        ...
        ::abt_boost::type_traits::ice_not< ::abt_boost::is_const<T>::value >::value,
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_assign,T,::abt_boost::detail::has_trivial_assign_impl<T>::value)
