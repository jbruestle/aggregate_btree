   ...
   ::abt_boost::type_traits::ice_or<\
      ::abt_boost::type_traits::ice_and<\
         ...
         ::abt_boost::type_traits::ice_and<\
            ...
            ::abt_boost::type_traits::ice_not< ::abt_boost::is_convertible< Rhs_nocv, bool >::value >::value\
         >::value\
      >::value,\
      ::abt_boost::type_traits::ice_and<\
         ...
         ::abt_boost::type_traits::ice_and<\
            ...
            ::abt_boost::type_traits::ice_not< ::abt_boost::is_convertible< Lhs_nocv, bool >::value >::value\
         >::value\
      >::value\
   >::value
