...
{
   BOOST_STATIC_CONSTANT(bool, value = (::abt_boost::detail::is_unsigned_values<T>::minus_one > ::abt_boost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned_imp
{
   typedef is_ununsigned_select_helper< 
      ::abt_boost::type_traits::ice_or<
         ...
         ::abt_boost::is_enum<T>::value>::value 
   > selector;
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::abt_boost::detail::is_unsigned_imp<T>::value)
#endif
