...
struct is_pointer_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (::abt_boost::type_traits::ice_and<
              ::abt_boost::detail::is_pointer_helper<T>::value
            , ::abt_boost::type_traits::ice_not<
                ::abt_boost::is_member_pointer<T>::value
                >::value
            >::value)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        (::abt_boost::type_traits::ice_and<
        ::abt_boost::detail::is_pointer_helper<typename remove_cv<T>::type>::value
            , ::abt_boost::type_traits::ice_not<
                ::abt_boost::is_member_pointer<T>::value
                >::value
            >::value)
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pointer,T,::abt_boost::detail::is_pointer_impl<T>::value)
