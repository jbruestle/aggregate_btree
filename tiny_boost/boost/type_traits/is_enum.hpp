...
# else
    template <class U> static ::abt_boost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(BOOST_MSVC, == 1300)                 \
    || BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::abt_boost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::abt_boost::type_traits::yes_type));
#  else
    template <class U>
    static ::abt_boost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::abt_boost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::abt_boost::is_convertible<typename abt_boost::add_reference<T>::type,::abt_boost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::abt_boost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::abt_boost::type_traits::ice_or<
           ::abt_boost::is_arithmetic<T>::value
         , ::abt_boost::is_reference<T>::value
         , ::abt_boost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::abt_boost::detail::is_enum_helper<
          ::abt_boost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::abt_boost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::abt_boost::detail::is_enum_impl<T>::value)
