...
This makes a tree, which acts just like a python dictionary (in fact it's [MutableMapping](http://docs.python.org/library/collections.html#collections-abstract-base-classes)).  For example, you could do the following:
````python
